...
<div class="photomemory">
    ...
    <a href="doDeletePhotoMemory.asp?id=<%=rs("id")%>"><img src="picture/delete.gif" border="0"></a>
							<a href="updatePhotoMemory.asp?id=<%=rs("id")%>"><img src="picture/edit.png" border="0"></a>
   </div>  
				 </div> <!-- / .services -->	
					<%
						rs.MoveNext
