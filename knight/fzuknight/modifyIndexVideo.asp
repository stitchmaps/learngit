...
<script type="text/javascript" charset="utf-8" src="js/lang/zh_CN.js"></script>
		...
		%> 
			<form id="articleModifyForm" action="doUpdateIndexVideo.asp" onsubmit="return toVaild()" method="post">
            <%
				' 创建链接对象
				...
				' 查询数据		
				set rs = cn.Execute("select * from index_video where id=1" )
			
			%>
				<div class="form_title">修改首页视频</div>
