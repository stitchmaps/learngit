...
<script type="text/javascript" charset="utf-8" src="js/lang/zh_CN.js"></script>
		...
		%>        
			<form id="articleModifyForm" action="doInsert.asp" onsubmit="return toVaild()" method="post">
				<div class="form_title">添加文章</div>
				<div class="form_content">
                <div class="operator-text">
					<ul>
						<li >文章标题:<input style="height:24px; font-size:16px" type="text" name="title" id="title"/></li>	
                        </ul>
                        </div>
                    <div class="operator-text">
                        <ul>
